              ...
              <div style={{
                ...
                {isAdmin && (
                  <button onClick={() => { closeMenu(); navigateTo("admin"); play("F5", "16n"); }}
                    className="home-tile"
                    style={{ height: 64, flexShrink: 0, background: "#C8960A", border: "none", padding: "0 24px", cursor: "pointer", color: "#1a1a1a", textAlign: "left", display: "flex", alignItems: "center", gap: 14 }}>
            ...
            <div style={{ gridRow: "2", gridColumn: "1", display: "grid", gap: 4, background: "#000", gridTemplateColumns: isAdmin ? "1fr 1fr 120px" : "1fr 1fr", minHeight: 0 }}>
              ...
              {isAdmin && (
                <button onClick={() => { navigateTo("admin"); play("F5", "16n"); }} onMouseEnter={() => play("D5", "64n")}
                  className="home-tile"
                  style={{ background: "#C8960A", border: "none", padding: "16px 16px", cursor: "pointer", color: "#1a1a1a", textAlign: "left", display: "flex", alignItems: "center", gap: 10 }}>
