export const T = {
  en: {
    ...
    onboarding: [
      { t: "Welcome to GridA", b: "One philosophy, five features for living intentionally. Here's a quick tour of what each one is for." },
      { t: "About GridA", b: "New to the app? The About GridA section in the top menu walks you through the concept, the story behind it, and tips for getting the most out of each tool." },
      { t: "Profile & Social", b: "Manage your account and connect with friends. You can share your Mandalart publicly, invite friends to group events, and send direct messages — all from the Social tab." },
      { t: "Planner", b: "For managing your day. Block time on a 144-cell grid, log events and to-dos, and see exactly where your hours go. Group events and recurring schedules are supported too." },
      { t: "Mandalart", b: "For mapping your goals. One central goal → 8 sub-goals → 64 concrete actions, all visible in a single 9×9 grid. Based on the method used by Shohei Ohtani." },
      { t: "Pomodoro Timer", b: "For staying focused. Name a task, set a duration, and work in structured intervals with built-in rest. Completed sessions are automatically archived." },
      { t: "Where to learn more", b: "Each tool has a built-in guide — look for the ? button when you're inside it. For a deeper overview, visit About GridA in the top menu anytime." },
    ],
    mandalartAbout: {
  ...
  ko: {
    ...
    onboarding: [
      { t: "GridA에 오신 걸 환영해요", b: "하나의 철학, 다섯 가지 기능으로 의도적으로 살아가요. 각 기능이 무엇을 위한 것인지 간단히 안내할게요." },
      { t: "About GridA", b: "처음 시작하셨나요? 상단 메뉴의 About GridA 섹션에서 앱의 개념과 배경, 각 도구를 잘 활용하는 팁을 확인할 수 있어요." },
      { t: "프로필 & 소셜", b: "계정을 관리하고 친구를 연결해요. 만다라트를 공개로 공유하거나, 친구를 그룹 일정에 초대하거나, 다이렉트 메시지를 보낼 수 있어요." },
      { t: "플래너", b: "하루를 관리하기 위한 도구예요. 144칸 그리드에 시간을 블로킹하고, 일정과 할 일을 기록하며 시간이 어디로 가는지 확인해요. 그룹 일정과 반복 일정도 지원해요." },
      { t: "만다라트", b: "목표를 설계하기 위한 도구예요. 핵심 목표 1개 → 세부 목표 8개 → 구체적 실행 항목 64개를 9×9 그리드 하나에 담아요. 오타니 쇼헤이가 사용한 방법을 기반으로 해요." },
      { t: "뽀모도로 타이머", b: "집중을 유지하기 위한 도구예요. 할 일을 적고 시간을 설정한 뒤, 구조화된 집중 구간과 휴식을 번갈아가며 작업해요. 완료된 세션은 자동으로 기록돼요." },
      { t: "더 자세히 알아보려면", b: "각 도구 안에는 내장 가이드가 있어요 — 도구를 열었을 때 ? 버튼을 찾아보세요. 전체적인 개요는 언제든지 상단 메뉴의 About GridA에서 확인할 수 있어요." },
    ],
    mandalartAbout: {
      title: "만다라트란?",
      body: [
